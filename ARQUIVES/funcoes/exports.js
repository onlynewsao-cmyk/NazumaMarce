...
const { addBanned, unBanned, BannedExpired, cekBannedUser } = require("../../ARQUIVES/js/banned.js");
    const namoro1 = JSON.parse(fs.readFileSync("./DADOS_SYSTEM/func/namoro1.json"));
const namoro2 = JSON.parse(fs.readFileSync("./DADOS_SYSTEM/func/namoro2.json"));
...
const { wait, getExtension, generateMessageID, getMembros, getGroupAdmins, normalizeJid, getRandom, banner, banner2, banner3, temporizador, chyt, getBuffer, fetchJson, fetchText, createExif, getBase64, convertSticker, upload, nit, getpc, supre, recognize, pegarCases, carregarMidia, pinterest } = require('../../ARQUIVES/funcoes/functions.js'); // É necessário para algumas funções funcionar perfeitamente.
...
// [JSON] - Funções Abaixo >>> :
const pushnames = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/usuarios/users.json'));
const obrigadoEXT = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/INFO_SYSTEM/media/nescessario.json'))
const rgtake = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/usuarios/take.json'));
const sotoy = JSON.parse(fs.readFileSync('./ARQUIVES/json/sotoy.json'));
const countMessage = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/INFO_SYSTEM/media/countmsg.json'));
const comandos = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/INFO_SYSTEM/media/comandos.json'));
const daily = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/usuarios/diario.json'));
const nescessario = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/INFO_SYSTEM/media/nescessario.json'));
const vip = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/usuarios/vip.json'));
const ban = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/usuarios/banned.json'));
const muted = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/grupos/muted.json'))
const limitefll = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/usuarios/flood.json'));
const joguinhodavelhajs = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/usuarios/joguinhodavelha.json'));
const joguinhodavelhajs2 = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/usuarios/joguinhodavelha2.json'));
const antispam = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/INFO_SYSTEM/media/antispam.json'));
const anotar = JSON.parse(fs.readFileSync("./DADOS_SYSTEM/func/anotar.json"));
const setting = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/INFO_SYSTEM/media/INFO_SYSTEM.json'));
const logoslink = JSON.parse(fs.readFileSync('./DADOS_SYSTEM/INFO_SYSTEM/LOGOS/links_img.json'));
const Limit_CMD = JSON.parse(fs.readFileSync("./DADOS_SYSTEM/func/limitarcmd.json"))
...
const { linguagem, mess, getInfo } = require('../../DADOS_SYSTEM/INFO_SYSTEM/lib');
...
const { baixarTikTok, buscarTtk } = require('../../ARQUIVES/funcoes/tiktok.js');
const { baixarInstagram } = require('../../ARQUIVES/funcoes/instagram.js');
...
var EnvBotao = async (id, MR, SystemDark, text1, desc1, X) => {
if(X.split("|")[1] != "0") {
SystemDark.sendMessage(id, {image: {url: X.split("|")[1]}, caption: text1, mentions: [MR]})} else {SystemDark.sendMessage(id, {text: text1, mentions: [MR]})}}
} else {
var EnvBotao = async(id, MR, SystemDark, text1, desc1, X, TXT = [], vr) => {
...
SystemDark.sendMessage(id, buttonMessage, {quoted: vr}).catch(e => {
