...
return "INICIANDO A SESSÃO DO SystemDark 😖"
}

exports.open = () => {
return "SystemDark CONECTADO COM SUCESSO AO WHATSAPP 💌"
}

exports.connecting = () => {
return "SystemDark CONECTANDO AO WHATSAPP, AGUARDE.. >_<"
}

exports.blackList = (GroupMetadata_, sab2, NomeDoBot) => { 
  ...
  const response = [
    ...
    `*ᴄᴀᴅᴇ̂ ᴀ ᴄᴀʀᴀ ᴅᴇ ᴘᴀᴜ? ᴀᴄʜᴏᴜ ǫᴜᴇ ɪᴀ ᴘᴀꜱꜱᴀʀ ɪʟᴇꜱᴏ? ɴᴀ̃ᴏ ᴄᴏᴍ ᴏ ${NomeDoBot} ᴀǫᴜɪ 💢🤨*`,
...
exports.perfilSystemDark = (pushname, sender, status, isChVip, isCargo, dadosUser, pct, programa, conselho, NomeDoBot) => {
...
├─ ⊹°❆ິ̸𝚄𝚂𝙴𝚁: @${u.id.split('@')[0]}
├─ ⊹°❆ິ̸𝙼𝚂𝙶: ${u.messages}
├─ ⊹°❆ິ̸𝙲𝙾𝙽𝙽𝙴𝙲𝚃: ${u.aparelho}
├─ ⊹°❆ິ̸𝙵𝙸𝙶: ${u.figus}
├─ ⊹°❆ິ̸𝙲𝙼𝙳: ${u.cmd_messages}
├─ ⊹°❆ິ̸𝚅𝙸𝙳𝙴𝙾: ${u.videos || 0}
├─ ⊹°❆ິ̸𝙸𝙼𝙶: ${u.imagens || 0}
├─ ⊹°❆ິ̸𝙰𝚄𝙳𝙸𝙾: ${u.audios || 0}
├─ ⊹°❆ິ̸𝙳𝙾𝙲: ${u.documentos || 0}
╰─── ･ ｡ﾟ☆: *.☽ .* :☆ﾟ. ───`;
}
...
•
> *\`https://chat.whatsapp.com/FJzPRs22QpQE35C6E9TqNM\``
}
...
return `${teks.titulo} *𝙱𝙰𝙸𝚇𝙰𝙳𝙾 𝙿𝙴𝙻𝙾 𝚃𝙾𝙺𝙸𝚃𝙾 𝙱𝙾𝚃 🙇‍♂️*`
}
...
return `ᯓ ⁺₊ ⋆˖⁺‧ 🪷 ‧⁺˖⋆ ⁺₊ ❆ິ̸ .ᐟ
❆ິ̸ !  [  *ᴏ ᴜꜱᴜᴀʀɪᴏ ꜱᴇ ᴇɴᴄᴏɴᴛʀᴀ ᴀᴜꜱᴇɴᴛᴇ ɴᴏ ᴍᴏᴍᴇɴᴛᴏ 💁‍♂️*  ]  
⋆  ⋆  
^_< -  🕊️ |  𝚄𝚂𝙴𝚁 : @${m.split('@')[0]}  
